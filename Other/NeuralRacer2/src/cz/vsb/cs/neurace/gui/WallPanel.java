...
public class WallPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        widthSpinner.setModel(new javax.swing.SpinnerNumberModel(Float.valueOf(1.0f), Float.valueOf(0.1f), Float.valueOf(20.0f), Float.valueOf(0.5f)));

        widthLabel.setText(Text.getString("width")); // NOI18N

        heightLabel.setText(Text.getString("height")); // NOI18N

        heightSpinner.setModel(new javax.swing.SpinnerNumberModel(Float.valueOf(1.0f), Float.valueOf(0.1f), Float.valueOf(20.0f), Float.valueOf(0.5f)));
